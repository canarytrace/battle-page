    ...
    div.innerHTML = `
      ...
      <a href="https://battle.canarytrace.com/" target="_blank" class="group" data-test-id="ob1">
        <div class="aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg xl:aspect-w-7 xl:aspect-h-8">
          <img src="${img.path}" alt="První cucavá tableta na světě, která slouží jako nutriční doplněk pro hráče." class="h-full w-full object-cover object-center group-hover:opacity-75">
        </div>
